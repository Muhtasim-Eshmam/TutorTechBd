...
<body>
     <form action="{{ route('mytuitions') }}" class="d-flex" method="get"> 
        @csrf
        <input class="form-control search-box" type="search" name="string" placeholder="Enter Your Code/Number" aria-label="Search">
...
<br>
<a href="http://127.0.0.1:8000/studentpanel" class="button">Close</a> 
